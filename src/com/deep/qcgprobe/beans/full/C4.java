...
* @param memory
*/
public C4(long cpus, String host, long memory, long memoryAlloc, String state, String queues) {
super();
this.cpus = cpus;
this.host = host;
this.memory = memory;
...
public C4 withHost(String host) {
this.host = host;
return this;
}
...
public C4 withMemory(long memory) {
this.memory = memory;
return this;
}
...
public C4 withMemoryAlloc(long memoryAlloc) {
this.memoryAlloc = memoryAlloc;
return this;
}
...
public C4 withState(String state) {
this.state = state;
return this;
}
...
public C4 withQueues(String queues) {
this.queues = queues;
return this;
}
