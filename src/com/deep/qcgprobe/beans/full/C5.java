...
* @param memory
*/
public C5(long cpus, String host, long memory, long memoryAlloc, String state, String queues) {
super();
this.cpus = cpus;
this.host = host;
this.memory = memory;
...
public C5 withHost(String host) {
this.host = host;
return this;
}
...
public C5 withMemory(long memory) {
this.memory = memory;
return this;
}
...
public C5 withMemoryAlloc(long memoryAlloc) {
this.memoryAlloc = memoryAlloc;
return this;
}
...
public C5 withState(String state) {
this.state = state;
return this;
}
...
public C5 withQueues(String queues) {
this.queues = queues;
return this;
}
